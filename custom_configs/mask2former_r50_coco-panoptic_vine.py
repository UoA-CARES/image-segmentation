_base_ = '../configs/mask2former/mask2former_r50_8xb2-lsj-50e_coco-panoptic.py'
...
work_dir = './output/vine/mask2former_r50_coco-panoptic'
...
vis_backends = [
    ...
    dict(type='WandbVisBackend',
         init_kwargs={
            'project': 'mmdetection',
            'group': 'mask2former_r50-coco-panoptic_vine'
         })
]
